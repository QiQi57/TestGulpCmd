...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>DigIt</title>
    <link type="text/css" rel="stylesheet" href="<%= FileUtility.SetJsVersion(Context,@"Styles/digitC.css") %>" />
    <link href="Styles/TreeMenuCss/digitC.css" rel="stylesheet" type="text/css" />
