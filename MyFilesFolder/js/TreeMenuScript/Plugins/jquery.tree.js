...
*/
(function ($) {
    //declare 3 array variables for separately storing the list of productlevel1, productlevel2 and productlevel3
    var productsLevel1 = [];
    var productsLevel2 = [];
    var productsLevel3 = [];
    ...
    $.fn.treeview = function (settings) {
            ...
            if (item.render && pstate != item.checkstate) {
                ...
                if (et.length == 1) {
                    ...
                    if (item.checkstate == 0) {
                        ...
                        //comment the level 1, because this level has no checkbox
                        //                        if (item.Level == 1) {
                        //                            var pOfElement = IsInArray(item.Value, productsLevel1);
                        //                            if (pOfElement == -1) {
                        //                                productsLevel1.push(item.Value);
                        //                            }
                        //                        }
                        if (item.Level == 2) {
        ...
        function setupSizeOfTree() {
            ...
            if (totalCount < 11) {
                ...
                newHeightOfTree = totalCount * 15 + 15;
            }
            else {
                newHeightOfTree = 30 * 15 + 15;
            }
