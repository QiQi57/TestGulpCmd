        ...
        $.ajax({
            ...
            success: function (result) {
                if (result == '"-1"') {
                    ...
                    $('#iframe').attr('src', 'ExportExcel.srv?type=ticlog');
                    $('#iframe').load();
                }
    ...
    $("#viewReportLink").click(function () {
        ...
        $.post(
            ...
            function (data) {
                ...
                //the reason why subtract 1 please refer to the GetTICLog1.cs files(in details, please check the comment befor return list)
                var rowLength = rowList.length - 1;
                if (rowLength < 1) {
                    $("#showData").show();
                ...
                //set overall info
                $("#totalUserSpan").text(rowLength);
                $("#totaluniqueuser").text(rowList[rowLength]["DistinctUsers"]);
                ...
                for (var i = 0; i < rowLength; i++) {
                    ...
                    var pageType = "";
                    var moduleType = "";
                    var generalQuery = rowList[i]["GeneralQuery"];
                    if (generalQuery == "DrilldownForSurVol") {
                        generalQuery = "Drilldown For Survey Volume";
                    }
                    else if (generalQuery == "DrilldownForRuleCounts") {
                        generalQuery = "Drilldown for Diag Rules";
                    }
                    rowString = "<tr style='background-color:" + backgroundColor + "'>" +
                            "<td>" + rowList[i]["VisitorName"] + "</td>" +
                            "<td>" + rowList[i]["ViewTime"] + "</td>" +
                            "<td>" + rowList[i]["ReportName"] + "</td>" +
                            "<td>" + rowList[i]["ProductLevel1"] + "</td>" +
                            "<td>" + rowList[i]["ProductLevel2"] + "</td>" +
                            "<td>" + rowList[i]["ProductLevel3"] + "</td>" +
                            "<td>" + rowList[i]["OffLevel1"] + "</td>" +
                            "<td>" + rowList[i]["OffLevel2"] + "</td>" +
                            "<td>" + rowList[i]["OffLevel3"] + "</td>" +
                             "<td>" + rowList[i]["CusRegLevel1"] + "</td>" +
                            "<td>" + rowList[i]["CusRegLevel2"] + "</td>" +
                            "<td>" + rowList[i]["CusRegLevel3"] + "</td>" +
                            "<td>" + rowList[i]["Region"] + "</td>" +
                            "<td>" + rowList[i]["RankBy"] + "</td>" +
                            "<td>" + rowList[i]["Taxonomy"] + "</td>" +
                            "<td>" + rowList[i]["TimeRange"] + "</td>" +
                            "<td>" + rowList[i]["SupportTopicLevel1"] + "</td>" +
                            "<td>" + rowList[i]["SupportFullPath"] + "</td>" +
                            "<td>" + generalQuery + "</td>";
