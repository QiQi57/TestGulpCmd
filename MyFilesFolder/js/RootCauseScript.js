...
$(document).ready(function () {
    ...
    $("#sbis").hover(function () {
        if ($(this).hasClass("clusterNoSelect"))
        {
            $(this).removeClass("clusterNoSelect");
            $(this).addClass("clusterSelect");
        }
    },
    function ()
    {
        ...
        if (selectedSource != "1") {
            $(this).removeClass("clusterSelect");
            $(this).addClass("clusterNoSelect");
        }
    }
    );
    $("#asbis_mssolve").hover(function () {
        if ($(this).hasClass("clusterNoSelect")) {
            $(this).removeClass("clusterNoSelect").addClass("clusterSelect");
        }
    },
    function () {
        if (selectedSource != "1,2") {
            $(this).removeClass("clusterSelect").addClass("clusterNoSelect");
        }
    }
    );
    $("#mssolve").hover(function () {
        if ($(this).hasClass("clusterNoSelect")) {
            $(this).removeClass("clusterNoSelect").addClass("clusterSelect");
        }
    }, function () {
...
function ChangeSource(id, val)
{
    $(".sourcestatus").removeClass("clusterSelect");
    $(".sourcestatus").addClass("clusterNoSelect");
    $("#" + id).addClass("clusterSelect");
    $("#" + id).removeClass("clusterNoSelect");
    selectedSource = val;
}
...
function enable(id, fullpath,type) {
    ...
    $("#detailsView").css("top", (position.top - 15) + "px");
    CloseDetailsBinding();
    return false;
}
...
function GetDetailsView(startDate, endDate, SupportTopicDerivedID, height, fullpath) {
    ...
    $.post(host + "/GetMSSolveSeamSRDetails.srv",
        { startDate: startDate, endDate: endDate, SupportTopicDerivedID: SupportTopicDerivedID, GeographyLevel3: GeographyLevel3, productVersion: productVersion,Source:selectedSource, PESServiceID: pesServicedId, type: "rootcause" },
        function (data) {
            ...
            if (rowLength < 1) {
                $("#detailsView").html("<span class='org_box_cor cor1'></span><div style='margin-top:7.5%; margin-left:3%;' id='testID'><div class='triangle-down' id='closeDetails'></div></div><p style='text-align:center; vertical-align:middle; color:#ffffff'>There's no details data.</p>");
                $("#detailsView").css("height", height);
                CloseDetailsBinding();
                return;
            }
            ...
            SavePageStatus(startDate, endDate, "", "", "", "", "", "", "", taxonomy, spl1, supportLevel1, "",
                GeographyLevel3, "", "", rankType, "", "Drilldown", "RootCause", productLevel1, productLevel2, productLevel3, path, "", "", "", "", "", "", offeringLevel1, offeringLevel2, offeringLevel3);
        });
}
...
function GetDetailsViewForSurVol(startDate, endDate, SupportTopicDerivedID, height, fullpath) {
    ...
    $.post(host + "/GetMSSolveSeamSurveyVolDetails.srv",
        ...
        function (data) {
            ...
            var offeringLevel2 = $("#OffLevel2HiddenP").val();
            var offeringLevel3 = $("#OffLevel3HiddenP").val();
            SavePageStatus(startDate, endDate, "", "", "", "", "", "", "", taxonomy, taxonomySelected, supportLevel1, "",
                GeographyLevel3, "", "", rankType, "", "DrilldownForSurVol", "RootCause", productLevel1, productLevel2, productLevel3, path, "", "", "", "", "", "", offeringLevel1, offeringLevel2, offeringLevel3);
        });
}
...
var flag = true;
function getTrendingData(SupportTopicDerivedID, fullPath, laborP, labor, TMPI, CaseVolumeP, CaseVolume, TB, BB, totalB, type,childType, Xlabor, trendID, title) {
    var host = getHostUrl();
    ...
    var productVersion = $("#copyProductVersion").val();
    var pesServicedId = $("#copyPESServicedID").val();
    var type = type; // "NotTopIssue";
    $.post(host + "/GetTrendingData.srv",
        { startDate: startDate, endDate: endDate, ClassificationId: supportTopicDerivedID,
        GeographyLevel3: GeographyLevel3, productVersion: productVersion,Source:selectedSource, type: type,childType:childType, PESServiceID: pesServicedId
        },
        function (data) {
            document.location.hash = "?guid=" + $("#txtGuid").val();
            var rowList = $.parseJSON(data);
    ...
    function showTrendingWindow(id, timerange, SupportTopicDerivedID, fullPath, laborP, labor, TMPI, CaseVolumeP, CaseVolume, TB, BB, totalB) {
        $("#VolumeTrending").html("<p style='color:#000000;margin-left:140px; margin-top:120px;'>Loading...</p>");
        $("#LaborTrending").html("<p style='color:#000000;margin-left:140px; margin-top:120px;'>Loading...</p>");
        $("#TMPITrending").html("<p style='color:#000000;margin-left:140px; margin-top:120px;'>Loading...</p>");
        flag = true;
        if (SupportTopicDerivedID == null) {
            ...
            $("#trendContent").html("<div><div style='margin-top:5%; margin-left:3%;'><div class='triangle-down-trend' id='closeTrend'></div></div>" +
                            "<div id='trending'>Trend Analysis</div><div class=treningDetails><table><tr><td colspan='2'><b>Root Cause:</b></td></tr>" +
                            ...
                            "</td></tr><tr><td width='50%'><b>Labor %:</b></td><td>" + laborP + "</td></tr><tr><td><b>Labor Hours:</b></td><td>" + labor + "</td></tr><tr><td><b>AVG TMPI:</b></td><td>"
            ...
            $("#TMPITrending").html("<p style='color:#000000;margin-left:180px; margin-top:120px;'>Loading...</p><img style='color:#000000;margin-left:90px; margin-top:10px;'" +
                                      " src='../../images/MetroLoading.gif' alt='calculating...' />");
            getTrendingData(SupportTopicDerivedID, fullPath, laborP, labor, TMPI, CaseVolumeP, CaseVolume, TB, BB, totalB, "RootCause","VOLUME", "Volume (numeric)", "trendingVolumeCanvas", "Volume Trend");
            getTrendingData(SupportTopicDerivedID, fullPath, laborP, labor, TMPI, CaseVolumeP, CaseVolume, TB, BB, totalB, "RootCause","LABOR", "Labor (hours)", "trendingLaborCanvas", "Labor Trend");
            getTrendingData(SupportTopicDerivedID, fullPath, laborP, labor, TMPI, CaseVolumeP, CaseVolume, TB, BB, totalB, "RootCause","TMPI", "TMPI (mins)", "trendingTMPICanvas", "TMPI Trend");
            ...
            var offeringLevel3 = $("#OffLevel3HiddenP").val();
            SavePageStatus(startDate, endDate, "", "", "", "", "", "", "", taxonomy, spl1, supportLevel1, "",
                GeographyLevel3, "", "", rankType, "", "Trending", "RootCause", productLevel1, productLevel2, productLevel3, path, "", "", "", "", "", "", offeringLevel1, offeringLevel2, offeringLevel3);
        }
    }
    ...
    function TrendClickEvent(trendID, timerange, SupportTopicDerivedID, fullpath, laborP, labor, TMPI, volumeP, volume, TB, BB, totalB) {
        ...
        $('#trendContent').css("background", "#0072C6");
        $t.css({
            top: to.top,
            left: to.left,
            display: 'block'
